...
export default function Index() {
  ...
  return (
    <App title="AI Chat Bot for Neurodivergents">
      <main className="bg-neutral-100 md:rounded-lg md:shadow-md p-6 w-full h-full flex flex-col" style={{ fontFamily: 'OpenDyslexic, sans-serif' }}>
              ...
              <>
                ...
                <div className="flex justify-center">
                  <p className="text-sm text-gray-500 mt-5">
                    ...
                    <a
                      className="underline"
                      href="https://github.com/davidjenner"
                    >
                      David
                    </a>
                  </p>
